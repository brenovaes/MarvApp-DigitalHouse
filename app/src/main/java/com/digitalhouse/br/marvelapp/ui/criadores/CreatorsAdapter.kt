...
class CreatorsAdapter (var listaCreators: ArrayList<ItemsCr?>, val listener: OnCreatorsClickListener): RecyclerView.Adapter<CreatorsAdapter.CreatorsViewHolder>() {

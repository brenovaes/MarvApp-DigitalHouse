...
//
//
//class Trilha02PerguntaActivity : AppCompatActivity() {
...
//        setContentView(R.layout.activity_trilha02_pergunta)
//
...
//        }
//
//        fun alertDialogDesistir() {
//            val builder = AlertDialog.Builder(this)
//
//            with(builder) {
//                setMessage("When you give up you will lose your progress on this trail. Are you sure you want to give up?")
//                setPositiveButton("Yes", DialogInterface.OnClickListener(function = this.positiveButtonClick)
